...
packer.uint40b = function (val) {
  var binary = [];
  binary[0] = (val / 0x100000000) & 0xFF;
  binary[1] = (val >> 24) & 0xFF;
  binary[2] = (val >> 16) & 0xFF;
  binary[3] = (val >> 8) & 0xFF;
  binary[4] = (val) & 0xFF;
  return binary;
...
packer.uint56l = function (val) {
  ...
  binary[4] = (val / 0x100000000) & 0xFF;
  binary[5] = (val / 0x10000000000) & 0xFF;
  binary[6] = (val / 0x1000000000000) & 0xFF;
  return binary;
};

packer.uint56b = function (val) {
  var binary = [];
  binary[0] = (val / 0x1000000000000) & 0xFF;
  binary[1] = (val / 0x10000000000) & 0xFF;
  binary[2] = (val / 0x100000000) & 0xFF;
  binary[3] = (val >> 24) & 0xFF;
  binary[4] = (val >> 16) & 0xFF;
  binary[5] = (val >> 8) & 0xFF;
  binary[6] = (val) & 0xFF;
  return binary;
};

packer.uint64l = function (val) {
  var binary = [];
  binary[0] = val & 0xFF;
  binary[1] = (val >> 8) & 0xFF;
  binary[2] = (val >> 16) & 0xFF;
  ...
  binary[5] = (val / 0x10000000000) & 0xFF;
  binary[6] = (val / 0x1000000000000) & 0xFF;
  binary[7] = (val / 0x100000000000000) & 0xFF;
  return binary;
};

packer.uint64b = function (val) {
  var binary = [];
  binary[0] = (val / 0x100000000000000) & 0xFF;
  binary[1] = (val / 0x1000000000000) & 0xFF;
  binary[2] = (val / 0x10000000000) & 0xFF;
  binary[3] = (val / 0x100000000) & 0xFF;
  binary[4] = (val >> 24) & 0xFF;
  binary[5] = (val >> 16) & 0xFF;
  binary[6] = (val >> 8) & 0xFF;
  binary[7] = (val) & 0xFF;
  return binary;
};
...
unpacker.uint56l = function (pointer, buffer) {
  var binary = buffer[pointer.offset++];
  binary |= buffer[pointer.offset++] << 8;
  binary |= buffer[pointer.offset++] << 16;
  binary |= buffer[pointer.offset++] << 24;
...
unpacker.uint56b = function (pointer, buffer) {
  var binary = buffer[pointer.offset++] * 0x1000000000000;
  binary += buffer[pointer.offset++] * 0x10000000000;
  binary += buffer[pointer.offset++] * 0x100000000;
  binary >>>= 0;
  binary |= buffer[pointer.offset++] < 24;
...
unpacker.uint64b = function (pointer, buffer) {
  var binary = buffer[pointer.offset++] * 0x100000000000000;
  binary += buffer[pointer.offset++] * 0x1000000000000;
  binary += buffer[pointer.offset++] * 0x10000000000;
  binary += buffer[pointer.offset++] * 0x100000000;
  binary >>>= 0;
